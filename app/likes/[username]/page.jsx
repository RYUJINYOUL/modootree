...
export default function LikesPage() {
  ...
  const canDelete = (like) => {
    ...
    console.log('Admin Emails:', ADMIN_UIDS);
    console.log('Is Admin?', ADMIN_UIDS.includes(currentUser.email));
    console.log('Like Author:', like.userId);
    console.log('Is Author?', like.userId === currentUser.uid);
