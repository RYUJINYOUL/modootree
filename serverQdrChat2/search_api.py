...
def classify_query(query: str) -> Tuple[SearchCategory, str]:
    ...
    # 🆕 일반 대화 패턴 감지 (최우선)
    chat_patterns = [
        "안녕", "하이", "hello", "좋은", "나쁜", "기분", "고마워", "감사", 
        "미안", "죄송", "사랑", "행복", "슬프", "화나", "짜증", "힘들",
        "어제", "오늘 기분", "내일 계획", "오늘 뭐했어", "심심해", "재미있어",
        "괜찮아", "잘했어", "수고했어", "피곤해", "배고파", "졸려"
    ]
    ...
    # 검색 키워드 매칭
    keywords = {
        SearchCategory.VIDEO: ["유튜브", "youtube", "영상", "동영상", "비디오"],
        SearchCategory.MUSIC: ["노래", "음악", "뮤직", "곡", "song", "music"],
