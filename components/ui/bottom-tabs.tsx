...
export function BottomTabs() {
  ...
  const hiddenPaths = ['/editor/', '/ai-comfort', '/profile', '/link-letter/', '/search', '/anonymous-chat', '/admin-request', '/link-letter'];
  const exactHiddenPaths = ['/ai-chat-simple', '/', '/search', '/pros-menu', '/anonymous-chat', '/admin-request', '/link-letter'];
