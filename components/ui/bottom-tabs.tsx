...
export function BottomTabs() {
  ...
  const hiddenPaths = ['/editor/', '/ai-comfort', '/profile', '/link-letter/', '/search', '/anonymous-chat', '/admin-request', '/link-letter', '/login', '/register', '/news-vote','/photo-story', '/modoo-vote'];
  const exactHiddenPaths = ['/ai-chat-simple', '/', '/search', '/pros-menu', '/anonymous-chat', '/admin-request', '/link-letter', '/login', '/register', '/register', '/news-vote','/photo-story', '/modoo-vote'];
